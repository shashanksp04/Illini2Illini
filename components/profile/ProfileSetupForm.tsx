            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="flex flex-col items-center gap-3">
                <label htmlFor="profile_picture" className="cursor-pointer group">
                  {draftImageUrl ? (
                    <div className="h-20 w-20 overflow-hidden rounded-full ring-2 ring-accent/20 group-hover:ring-accent group-hover:shadow-glow transition-all duration-200">
                      {/* Live preview of selected framing before upload. */}
